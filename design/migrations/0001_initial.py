    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('operand_service', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='ruled_as_operand_service', to='design.service', verbose_name='所操作服务')),
