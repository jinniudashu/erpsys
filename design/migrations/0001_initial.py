# Generated by Django 4.2.7 on 2024-06-23 13:35
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('field_type', models.CharField(blank=True, choices=[('CharField', '单行文本'), ('IntegerField', '整数'), ('TypeField', '类型'), ('InstanceField', '实例'), ('User', '系统用户'), ('DecimalField', '固定精度小数'), ('TextField', '多行文本'), ('DateTimeField', '日期时间'), ('DateField', '日期'), ('JSONField', 'JSON'), ('FileField', '文件'), ('ComputedField', '计算字段')], default='CharField', max_length=50, null=True, verbose_name='数据类型')),
        ...
        migrations.AddField(
            model_name='service',
            name='form',
            field=models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='design.form', verbose_name='表单'),
        ),
        migrations.AddField(
            model_name='service',
            name='route_to',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='routed_services', to='design.dataitem', verbose_name='传递至'),
        ),
        migrations.AddField(
            model_name='service',
            name='subject',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='served_services', to='design.dataitem', verbose_name='作业对象'),
        ),
        migrations.AddField(
            model_name='service',
            name='work_order',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='ordered_service', to='design.dataitem', verbose_name='工单'),
        ),
        migrations.CreateModel(
