    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('allowed_operators', models.ManyToManyField(blank=True, related_name='operator_allowed_services', to='design.operator', verbose_name='允许操作员')),
                ('allowed_roles', models.ManyToManyField(blank=True, related_name='role_allowed_services', to='design.role', verbose_name='允许角色')),
            ],
            options={
                'verbose_name': '服务',
