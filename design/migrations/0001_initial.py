    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('implement_type', models.CharField(choices=[('Field', '字段'), ('Model', '数据表'), ('View', '视图'), ('MenuItem', '菜单项'), ('KernelModel', '系统表'), ('Program', '程序'), ('Log', '日志')], default='Field', max_length=50, verbose_name='实现类型')),
