# Generated by Django 4.2.7 on 2024-07-06 07:48
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('allowed_operators', models.ManyToManyField(blank=True, related_name='allowed_services', to='design.operator', verbose_name='允许操作员')),
            ],
            options={
                'verbose_name': '服务',
        ...
        migrations.AddField(
            model_name='service',
            name='reference',
            field=models.ManyToManyField(blank=True, related_name='referenced_services', to='design.dataitem', verbose_name='参考对象'),
        ),
        migrations.AddField(
            model_name='service',
            name='route_to',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='routed_services', to='design.operator', verbose_name='传递至'),
        ),
        migrations.AddField(
            model_name='service',
            name='subject',
        ...
        migrations.AddField(
            model_name='service',
            name='work_order',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='ordered_service', to='design.workorder', verbose_name='工单'),
        ),
        migrations.CreateModel(
