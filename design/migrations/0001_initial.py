    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creator', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='design.operator', verbose_name='创建者')),
                ('entity_content_type', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='contenttypes.contenttype', verbose_name='实体类型')),
            ],
            options={
                'verbose_name': '服务-程序',
                'verbose_name_plural': '服务-程序',
                'ordering': ['id'],
            },
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('service_program', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='design.serviceprogram', verbose_name='服务程序')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('entity_object_id', models.PositiveIntegerField(blank=True, null=True, verbose_name='实体ID')),
                ('parameter_values', models.JSONField(blank=True, null=True, verbose_name='参数值')),
                ('belongs_to_service', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='services_belong_to', to='design.service', verbose_name='隶属服务')),
                ('entity_content_type', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='design_service_func', to='contenttypes.contenttype', verbose_name='实体类型')),
                ('event', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='design.event', verbose_name='事件')),
                ('operand_service', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='design_ruled_as_next_service_func', to='design.service', verbose_name='后续服务')),
