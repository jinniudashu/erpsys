...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('hypernymy', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='hyponymies', to='design.dataitem', verbose_name='上位词')),
                ('hyponymy', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='hypernymies', to='design.dataitem', verbose_name='下位词')),
            ],
            options={
                'verbose_name': '上下义关系',
