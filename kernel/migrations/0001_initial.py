    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('service', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='kernel.service', verbose_name='操作员')),
            ],
            options={
                'verbose_name': '工单',
        ...
        migrations.AddField(
            model_name='operator',
            name='role',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='operators', to='kernel.role', verbose_name='角色'),
        ),
        migrations.AddField(
            model_name='operator',
            name='user',
