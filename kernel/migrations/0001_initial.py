    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('path', models.CharField(blank=True, max_length=512, null=True, verbose_name='路径')),
                ...
                ('customer', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='as_customer_process', to='kernel.operator', verbose_name='客户')),
