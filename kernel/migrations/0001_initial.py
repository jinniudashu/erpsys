    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('entity_object_id', models.PositiveIntegerField(blank=True, null=True, verbose_name='实体ID')),
                ('parameter_values', models.JSONField(blank=True, null=True, verbose_name='参数值')),
                ('belongs_to_service', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='services_belong_to', to='kernel.service', verbose_name='隶属服务')),
                ('entity_content_type', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='kernel_service_func', to='contenttypes.contenttype', verbose_name='实体类型')),
                ('event', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='kernel.event', verbose_name='事件')),
                ('operand_service', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='kernel_ruled_as_next_service_func', to='kernel.service', verbose_name='后续服务')),
                ('service', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='kernel.service', verbose_name='服务')),
                ('system_instruction', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='kernel.instruction', verbose_name='系统指令')),
            ],
            options={
                'verbose_name': '服务函数库',
                'verbose_name_plural': '服务函数库',
